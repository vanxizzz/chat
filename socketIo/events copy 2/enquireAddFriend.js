...
async function enquireAddFriend({ targetAccount, info, targetName, title, allow }, socket, io) {
...
exports.enquireAddFriend = enquireAddFriend;
exports.event = (socket, io) => {
    socket.on("enquireAddFriend", async ({ targetAccount, info, targetName, title, allow = null }) => {
        enquireAddFriend({ targetAccount, info, targetName, title, allow }, socket, io)
    })
}